package com.viching.fastdfs.domain;

import com.viching.fastdfs.exception.FdfsUnavailableException;
...
public class TrackerLocator {
    ...
    /** 轮询圈 */
    private com.viching.fastdfs.domain.CircularList<TrackerAddressHolder> trackerAddressCircular = new com.viching.fastdfs.domain.CircularList<TrackerAddressHolder>();
