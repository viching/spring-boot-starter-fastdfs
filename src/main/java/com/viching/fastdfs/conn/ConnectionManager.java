...
import com.viching.fastdfs.exception.FdfsException;
import com.viching.fastdfs.proto.FdfsCommand;
...
public class ConnectionManager {
    ...
    public <T> T executeFdfsCmd(InetSocketAddress address, FdfsCommand<T> command) {
        ...
        // 获取连接
        com.viching.fastdfs.conn.Connection conn = getConnection(address);
        // 执行交易
     ...
     * @return
     */
    protected <T> T execute(InetSocketAddress address, com.viching.fastdfs.conn.Connection conn, FdfsCommand<T> command) {
        try {
            // 执行交易
     ...
     * @return
     */
    protected com.viching.fastdfs.conn.Connection getConnection(InetSocketAddress address) {
