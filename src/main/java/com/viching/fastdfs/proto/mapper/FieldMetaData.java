...
class FieldMetaData {
    ...
    public FieldMetaData(Field mapedfield, int offsize) {
        com.viching.fastdfs.proto.mapper.FdfsColumn column = mapedfield.getAnnotation(FdfsColumn.class);
    ...
    public Object getValue(byte[] bs, Charset charset) {
        if (String.class == field.getType()) {
            ...
            return com.viching.fastdfs.proto.mapper.BytesUtil.buff2long(bs, offsize);
        } else if (int.class == field.getType()) {
            return (int) com.viching.fastdfs.proto.mapper.BytesUtil.buff2long(bs, offsize);
        } else if (java.util.Date.class == field.getType()) {
            return new Date(com.viching.fastdfs.proto.mapper.BytesUtil.buff2long(bs, offsize) * 1000);
        } else if (byte.class == field.getType()) {
            return bs[offsize];
        } else if (boolean.class == field.getType()) {
            return bs[offsize] != 0;
    ...
    public byte[] toByte(Object bean, Charset charset)
        ...
        if (isDynamicField()) {
            ...
            // 如果是动态属性
            return com.viching.fastdfs.proto.mapper.BytesUtil.objString2Byte((String) value, max, charset);
        } else if (long.class.equals(field.getType())) {
            return com.viching.fastdfs.proto.mapper.BytesUtil.long2buff((long) value);
        } else if (int.class.equals(field.getType())) {
            return com.viching.fastdfs.proto.mapper.BytesUtil.long2buff((int) value);
    ...
    private byte[] getDynamicFieldByteValue(Object value, Charset charset) {
        ...
        // 如果是打包剩余的所有Byte
        case allRestByte:
            return com.viching.fastdfs.proto.mapper.BytesUtil.objString2Byte((String) value, charset);
        // 如果是文件MetaData
        case metadata:
