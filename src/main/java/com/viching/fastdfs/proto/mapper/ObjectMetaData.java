package com.viching.fastdfs.proto.mapper;
...
public class ObjectMetaData {
    ...
    /** 映射列(全部) */
    private List<com.viching.fastdfs.proto.mapper.FieldMetaData> fieldList = new ArrayList<com.viching.fastdfs.proto.mapper.FieldMetaData>();

    /** 动态计算列(部分)fieldList包含dynamicFieldList */
    private List<com.viching.fastdfs.proto.mapper.FieldMetaData> dynamicFieldList = new ArrayList<com.viching.fastdfs.proto.mapper.FieldMetaData>();
    ...
    public List<com.viching.fastdfs.proto.mapper.FieldMetaData> getFieldList() {
     ...
     * @return
     */
    private <T> List<com.viching.fastdfs.proto.mapper.FieldMetaData> praseFieldList(Class<T> genericType) {
        Field[] fields = genericType.getDeclaredFields();
        List<com.viching.fastdfs.proto.mapper.FieldMetaData> mapedFieldList = new ArrayList<com.viching.fastdfs.proto.mapper.FieldMetaData>();
        for (int i = 0; i < fields.length; i++) {
            if (fields[i].isAnnotationPresent(FdfsColumn.class)) {
                com.viching.fastdfs.proto.mapper.FieldMetaData fieldMetaData = new com.viching.fastdfs.proto.mapper.FieldMetaData(fields[i], fieldsTotalSize);
    ...
    private void validatFieldListDefine() {
        for (com.viching.fastdfs.proto.mapper.FieldMetaData field : fieldList) {
     ...
     * @param field
     */
    private void validatFieldItemDefineByIndex(com.viching.fastdfs.proto.mapper.FieldMetaData field) {
        for (com.viching.fastdfs.proto.mapper.FieldMetaData otherfield : fieldList) {
    ...
    private int getDynamicFieldSize(Object obj, Charset charset)
        ...
        int size = 0;
        for (com.viching.fastdfs.proto.mapper.FieldMetaData field : dynamicFieldList) {
    ...
    public void dumpObjectMetaData() {
        ...
        LOGGER.debug("----------------------------------------");
        for (com.viching.fastdfs.proto.mapper.FieldMetaData md : fieldList) {
