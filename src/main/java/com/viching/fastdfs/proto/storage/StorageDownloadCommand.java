...
import com.viching.fastdfs.proto.storage.internal.StorageDownloadRequest;
import com.viching.fastdfs.proto.storage.internal.StorageDownloadResponse;
...
public class StorageDownloadCommand<T> extends AbstractFdfsCommand<T> {
    ...
    public StorageDownloadCommand(String groupName, String path, long fileOffset, long fileSize,
            com.viching.fastdfs.proto.storage.DownloadCallback<T> callback) {
        super();
