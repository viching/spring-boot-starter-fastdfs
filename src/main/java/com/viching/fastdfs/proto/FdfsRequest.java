...
import com.viching.fastdfs.proto.mapper.FdfsParamMapper;
import com.viching.fastdfs.proto.mapper.ObjectMetaData;
...
public abstract class FdfsRequest {
    ...
    /** 报文头 */
    protected com.viching.fastdfs.proto.ProtoHead head;
    /** 发送文件 */
