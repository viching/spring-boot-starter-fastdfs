package com.viching.fastdfs.proto;

import com.viching.fastdfs.conn.Connection;
import com.viching.fastdfs.exception.FdfsIOException;
...
public abstract class AbstractFdfsCommand<T> implements FdfsCommand<T> {
    ...
    protected T receive(InputStream in, Charset charset) throws IOException {
        ...
        // 解析报文头
        com.viching.fastdfs.proto.ProtoHead head = ProtoHead.createFromInputStream(in);
